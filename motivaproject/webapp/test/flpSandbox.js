		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tax Reconciliation Process",
									"targetURL": "#comsapmottaxreconmotivaproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapmottaxreconmotivaproject-display": {
								"semanticObject": "comsapmottaxreconmotivaproject",
								"action": "display",
								"description": "Tax Reconciliation Process",
								"title": "Tax Reconciliation Process",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.mot.tax.recon.motivaproject",
									"url": sap.ui.require.toUrl("com/sap/mot/tax/recon/motivaproject")
								}
							}
						}
					}
